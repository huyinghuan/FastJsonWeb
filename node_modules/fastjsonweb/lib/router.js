...
function route(path){
	...
	//console.log("request's path is"+path+" ====  Disk path is"+ realpath);
	var actionpath = systemPathUtils.join(process.cwd(),realpath);
	try{
		...
		action["object"] =  routerHandle.requestNotFound();//Deal with 404 Errors
